...
To generate all figures used in this paper, you can simply run main.m. You should run this file while in the
folder: "IEEE_TCST_2024". If you are in a different folder, the code might not work.
__________________________________________
...
This includes each section in the manuscript, but also the 
bibliograpy and template files.
