...
function [U0,J,flag,output] = MPC_EXP_LABview(y,U0,d_MPC,vTMS,vMPC,optionsMPC)
%% Constants
P = vMPC.Npx;
ns = vTMS.ns;
nx = vTMS.nx;
...
states_ordered = [9 13 5 4 4 65:67 83:85 101:103 119:121 68:70 86:88 104:106 122:124 71:73 89:91 107:109 125:127 74:76 92:94 110:112 128:130 77:79 95:97 113:115 131:133 80:82 98:100 116:118 134:136];

%% Get System Initial Condition
x0 = y(states_ordered)';
x0(4) = 0.5*(y(4) + y(11));
