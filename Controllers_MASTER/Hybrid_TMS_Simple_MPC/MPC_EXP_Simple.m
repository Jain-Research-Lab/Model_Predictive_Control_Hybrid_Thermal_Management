...
function [U0,J,flag,output] = MPC_EXP_Simple(x0,U0,d_MPC,vTMS,vMPC,optionsMPC)
%% Constants
P = vMPC.Npx;
ns = vTMS.ns;
nx = vTMS.nx;
...
%% Cost Function Definition
    function [J,dJ] = obj_EXP(ubig,x0,d_MPC,Ru,Ru_m,Rdu,Rdu_m,RdJ_dU,P,nx,nu,vMPC,C,vTMS,E,dJdy,Z2)
        ...
        [x0,~,Di0,Su] = Hybrid_TMS_Model_EXP0_Simple(x0,ui,di,vTMS,E);
        ...
        for i = 1:P
            ...
            % evolve system for dt seconds
            [x0,Sx,Di0,Su] = Hybrid_TMS_Model_EXP_Simple(x0,ui,di,vTMS,Di0,E);
