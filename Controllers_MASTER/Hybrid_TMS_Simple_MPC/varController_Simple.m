...
classdef varController_Simple < handle
    ...
    methods
        ...
        function [varNMPC, vNMPC] = varController_Simple(varTMS)
            ...
            vNMPC = compute_NMPC_struct(varNMPC);
        end
        ...
        function vNMPC = compute_NMPC_struct(varNMPC)
            % NMPC Discretization
